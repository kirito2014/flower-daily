    ...
    <>
      <div 
        ...
        className={`
          ...
          /* === 核心修复：仅编辑时应用蓝色边框动效和高层级 === */
          ${isEditing ? 'card-editing-active z-[100]' : 'hover:shadow-md z-0'}
        `}
      >
        {/* === 列表内容行 === */}
        ...
        {isEditing && (
          ...
          >
             {/* 顶部指示箭头 (居中) */}
             <div className="absolute -top-2 left-1/11 -translate-x-1/2 w-4 h-4 bg-white border-t border-l border-stone-200 transform rotate-45"></div>
